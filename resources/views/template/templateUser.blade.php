...
<head>
    ...
    <!--
			CSS
			============================================= -->
    <link rel="stylesheet" href="{{ asset('assets/css/user/linearicons.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/user/css/font-awesome.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/user/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/user/owl.carousel.css') }}">
...
<body>
    ...
    <section class="default-banner active-blog-slider">
        <div id="carouselExampleInterval" class="carousel slide " data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active item-slider relative" data-bs-interval="10000">
    ...
    <script src="{{ asset('assets/js/user/slick.js') }}"></script>
    <script src="{{ asset('assets/js/user/jquery.counterup.min.js') }}"></script>
    <script src="{{ asset('assets/js/user/waypoints.min.js') }}"></script>
